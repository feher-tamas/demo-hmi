...
const ManualDACIcon = (): ReactElement => {
    ...
    return(
        <svg 
            ...
            <path 
                ...
                strokeLinejoin="round"/>
            <path 
                d="M6.93774 20.1666H5.50903V17.422L4.22046 19.0114H4.10767L2.81567 17.422V20.1666H1.42798V15.4293H2.72339L4.17944 17.2067L5.64233 15.4293H6.93774V20.1666Z" 
                fill={color}/>
        </svg>
    )
}
export default ManualDACIcon;